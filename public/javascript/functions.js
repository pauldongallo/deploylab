...
var countryCode2				= "";
var name						= "";
var varAdNewStoreDeliverCountry = "";
var storeNameTrim				= "";
var storeNameTrimWithID 		= "";
var count 						= "";
var tempPassword				= "";
var tempPasswordWithID			= "";
var addCount 					= "";
var userCallback				= "";
var ownerFirstName				= "";
var ownerLastName				= "";
...
var townCity					= "";	
var postalCode					= "";
var addNewStorecountryState		= "";
var addressSuburb				= "";
var addNewStoreAddressCountry	= "";
var storeName 					= "";
var storeEmail					= "";
var storePhone 					= "";
var storeFax					= "";
var storeMobile					= "";
var billing_fax_phone			= "";
var billing_address_3			= "";
var billing_mobile_phone		= "";
var billing_suburb				= "";
var billing_suburb				= "";
var customerCount				= "";
var totalCount					= "";
...
function js_mod_init(){
	...
	*
	*/
		/** load countries on dashboard **/
		// findCountries();

		/** get the total rows on customers **/
		countOrders();
	...
	*/
	$(document).on('click', '.close', function(){
		$("form#addNewStore")[0].reset();
		$("#addNewStoreAddressCountry option:selected").prop("selected", false);
		$("#addNewStorecountryState option:selected").prop("selected", false);
	});
...
function removeSpacing(text){
    ...
    var trimTextReplace = trimText.replace(/\s/g, '');

	return trimTextReplace;

}

function textSmallCaps(text){
